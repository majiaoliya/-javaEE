...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        n = 10;
        for(int i=0; i<n; i++) mp.put(i+"", "i=" + i);
        cout.println(mp);
        mp.put(3+"", "eat shit");
        cout.println(mp);
        ...
        for(String s : keys)
            cout.printf("[%s] ", mp.get(s));
        Set<Map.Entry<String, String>> ety = mp.entrySet();
        for (Map.Entry<String, String> entry : ety) {
        ...
        Random r = new Random();
        Map<String, Point> mp2 = new HashMap<>();
        for(int i=0; i<8; i++) {
            mp2.put(i+"", new Point(r.nextInt(), r.nextInt()));
        }
