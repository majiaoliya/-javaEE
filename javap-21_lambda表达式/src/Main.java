...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Thread th = new Thread(()->{ cout.printf("run func"); });
        th.start();

        String str[] = { "fuck", "you", "eat", "shit" };
        Arrays.sort(str, (String x, String y)->{ return x.length() - y.length(); });
        Arrays.sort(str, (x, y)->{ return x.length() - y.length(); });
        if(debug) {
