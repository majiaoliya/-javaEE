...
<div class="container">
    ...
    <div style="float: left;">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath}/pageServlet">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <c:if test="${pageBean.currentPage>1}">
                    <li>
                        <a href="${pageContext.request.contextPath}/pageServlet?currentPage=${pageBean.currentPage-1}&pageSize=${pageBean.pageSize}" aria-label="Previous">
                ...
                <c:if test="${pageBean.currentPage<=1}">
                    <li class="disabled" disabled="false">
                        <a href="${pageContext.request.contextPath}/pageServlet?currentPage=${1}&pageSize=${pageBean.pageSize}" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    </li>
                </c:if>
                ...
                <c:forEach begin="1" end="${pageBean.totPage}" var="i">
                    <c:if test="${i == pageBean.currentPage}">
                        <li class="active"><a href="${pageContext.request.contextPath}/pageServlet?currentPage=${i}&pageSize=${pageBean.pageSize}">${i}</a></li>
                    </c:if>
                    <c:if test="${i != pageBean.currentPage}">
                        <li><a href="${pageContext.request.contextPath}/pageServlet?currentPage=${i}&pageSize=${pageBean.pageSize}">${i}</a></li>
                    </c:if>
                </c:forEach>

                <c:if test="${pageBean.currentPage<pageBean.totPage}">
                    <li>
                        <a href="${pageContext.request.contextPath}/pageServlet?currentPage=${pageBean.currentPage+1}&pageSize=${pageBean.pageSize}" aria-label="Next">
                ...
                <c:if test="${pageBean.currentPage>=pageBean.totPage}">
                    <li class="disabled" disabled="false">
                        <a href="${pageContext.request.contextPath}/pageServlet?currentPage=${pageBean.totPage}&pageSize=${pageBean.pageSize}" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                </c:if>
