...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        class WuZaiYuan extends Hero {
            public WuZaiYuan(String name, String color, String jineng) {
                super(name, color, jineng);
            }
        ...
        WuZaiYuan wzy = new WuZaiYuan("伍再远", "绿色", "吃屎");
        list.add(wzy);
        for (Hero hero : list) hero.shifang();
