...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        cout.printf("[local:%s]\n", localHost);
        InetAddress ip[] = new InetAddress[8];
        ip[0] = InetAddress.getByName("192.168.10.114");
        ip[1] = InetAddress.getByName("192.168.4.50");
        ip[2] = InetAddress.getByName("192.168.4.53"); //蟹老板
        cout.printf("[ia:%s]\n[hostName:%s]\n[ip:%s]\n",
                ip[0], ip[0].getHostName(), ip[0].getHostAddress());
