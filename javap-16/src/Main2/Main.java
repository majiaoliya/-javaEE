...
class Th implements Runnable {
    ...
    public void run() {
        try(
            BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(Main.OUTPATH));
            BufferedInputStream bis = new BufferedInputStream(new FileInputStream(Main.INPATH));
        ) {
