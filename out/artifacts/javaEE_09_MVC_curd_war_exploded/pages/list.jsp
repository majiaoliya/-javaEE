...
<div class="container">
    ...
    <div style="float: right;margin: 5px;">
        ...
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/add_servlet">添加联系人</a>
        <a class="btn btn-primary" href="javascript:void(0)" id="delete_check">删除选中</a>
        <a class="btn btn-primary" href="javascript:void(0)" id="remake">恢复以删除数据</a>
    </div>
    <form action="${pageContext.request.contextPath}/deleteSelectUser" id="myform" method="post">
    ...
    <script>
        ...
        remake.onclick = function (ev) {
            location.href = "${pageContext.request.contextPath}/remake";
        }
    </script>
</body>
</html>
