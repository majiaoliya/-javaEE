...
class Thread1 extends Thread {
    public String in_path, out_path;
    
    @Override
    public void run() {
        try {
            BufferedInputStream bis = new BufferedInputStream(new FileInputStream(in_path));
            BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(out_path));
...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        th.in_path = "C:\\Users\\majiao\\Desktop\\timg.jpg";
        th.out_path = "C:\\Users\\majiao\\Desktop\\liya.jpg";
        th.start();
        Thread.sleep(1024);
