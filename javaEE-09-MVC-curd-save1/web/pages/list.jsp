    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${all_users}" var="user" varStatus="s">
            <tr>
                ...
                <td><a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/pages/update.jsp?id=${user.id}&username=${user.username}&gender=${user.gender}&age=${user.age}&qq=${user.qq}&email=${user.email}">修改</a>&nbsp;<a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/deleteUser?id=${user.id}">删除</a></td>
